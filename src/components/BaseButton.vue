...
import { BUTTON_TYPE_PRIMARY,BUTTON_TYPE_WARNING, BUTTON_TYPE_SUCCESS, BUTTON_TYPE_DANGER, BUTTON_TYPE_NEUTRAL,  } from '../../constants.js'
...
<template>
  <button :class="`${typeButtonClasses[type]} rounded p-3 disabled:cursor-not-allowed disabled:opacity-50`">
    <slot></slot>
  </button>
</template>
